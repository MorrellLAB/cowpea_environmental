...
Output ="/panfs/jay/groups/9/morrellp/rakakpo/Cowpea_Environment_Association/envGWAS/GWAS_Without_SE_Acc_hmp"
...
myFarmCPU<-GAPIT(Y=myY,G=myG,PCA.total=5,SNP.MAF=0.02, Major.allele.zero = TRUE,model="FarmCPU")
