...
* The bioRxiv manuscript is available as: \
Akakpo R, Lee EJ, Pacheco JB, Rios EF, Kantar MB, Ousmane B, Volz KM, Akinmade H, Getino L, Boote KJ, et al. 2025. Identification of genetic variation associated with high-temperature tolerance in cowpea. [bioRxiv. doi:10.1101/2025.04.09.647789](https://doi.org/10.1101/2025.04.09.647789)

* The publication in Molecular Ecology is available as: \
Akakpo R, Lee EJ, Pacheco JB, Rios EF, Kantar MB, Boukar O, Volz KM, Akinmade H, Getino L, Boote KJ, Muñoz-Amatriaín M, Morrell PL (2026) Identification of genetic variation associated with heat tolerance in cowpea (Vigna unguiculata l. Walp.). [Mol Ecol 35: e70327.](https://doi.org/10.1111/mec.70327)

## UCR collaborators cowpea GWAS
[cowpea_gwas](https://github.com/cjfiscus/cowpea_gwas)

## Description
Using SNP data available from IITA Core accessions, structure of population analysis in ~600 accessions of African cowpea will be performed. Various population Genetic analysis including population-based estimate of recombination rate  [Ped/pop method](https://doi.org/10.1101/gr.067181.107). Using the same data we will carrie out environmental genome wide association study . 
